...
void checkForCalibration()
{
  ...
  //    adjustDistance();
  //  }
  else if ((LF == 1 && LB == 1) && previousLF == 1)
  {
    LeftWall();
  ...
  if (adjustFrontFailCount >= 4 && (previousLF == 1 && (LF == 1 || LB == 1)))
  {
    turnLeft(90);
    FrontWall();
    delay(100);
  ...
  else if (adjustFailCount >= 4 || adjustFrontFailCount >= 4)
  {
    if (previousR == 1 && R == 1)
    {
      turnRight(90);
